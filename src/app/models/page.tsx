    ...
    if (modelType && modelResults) {
      try {
        ...
        setSavedModels((prev) => {
          ...
          if (prev.some((m) => m.created === newModel.created && m.type === newModel.type)) {
            return prev
          }
      ...
      <div className="container mx-auto py-10 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
            <h1 className="text-3xl font-bold tracking-tight">Saved Models</h1>
            <Link href="/upload">
              <Button>
          ...
          <Card className="border-border/40 bg-card/50 backdrop-blur-sm">
            <CardHeader>
              ...
              <CardDescription>View, download, or delete your previously trained models</CardDescription>
            </CardHeader>
                    ...
                    <TableRow key={model.id}>
                      ...
                      <TableCell className="text-right">
                        <div className="flex justify-end gap-2">
                          ...
                          <Button variant="outline" size="icon" onClick={() => handleDownloadModel(model)}>
            ...
            <CardFooter className="flex flex-col sm:flex-row justify-between border-t pt-6 gap-4">
              <div className="text-sm text-muted-foreground">Showing {savedModels.length} models</div>
              <Button variant="outline" disabled={savedModels.length === 0}>
