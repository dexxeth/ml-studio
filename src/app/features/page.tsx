	...
	useEffect(() => {
		...
		try {
			...
			const features = parsedDataset.columns.map((column, colIndex) => {
				...
				const sampleValues = parsedDataset.data
					.slice(0, 10)
					.map((row) => row[colIndex]);
				const isNumerical = sampleValues.every(
						...
						<TabsContent value="automatic">
							<Card className="border-border/40 bg-card/50 backdrop-blur-sm">
								<CardHeader>
									...
									<CardDescription>
										Our system analyzes your dataset and
										recommends the most important features
									</CardDescription>
								</CardHeader>
								<CardContent>
						...
						<TabsContent value="manual">
							<Card className="border-border/40 bg-card/50 backdrop-blur-sm">
								<CardHeader>
									...
									<CardDescription>
										Select which features you want to
