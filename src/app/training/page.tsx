                ...
                <div className="flex flex-col items-center justify-center py-6 space-y-4">
                  <div className="text-center">
                    <p className="text-muted-foreground mb-4">
                      Ready to train your {modelType.replace("_", " ")} model with {100 - testSize}% training data
                      {crossValidation ? " and cross-validation" : ""}
                    </p>
            ...
            <Tabs defaultValue="metrics" className="w-full">
              ...
              <TabsContent value="metrics">
                <Card className="border-border/40 bg-card/50 backdrop-blur-sm">
                  <CardHeader>
                    ...
                    <CardDescription>
                      Evaluation metrics for the trained {modelType.replace("_", " ")} model
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      {[
                        ...
                        { name: "Precision", value: modelResults.precision },
                        { name: "Recall", value: modelResults.recall },
                        { name: "F1 Score", value: modelResults.f1_score },
                      ].map((metric, i) => (
                    ...
                    <Alert className="mt-6">
                      ...
                      <AlertDescription>
                        Your model has achieved excellent results. It's ready for deployment.
                      </AlertDescription>
                    </Alert>
                  </CardContent>
                  ...
                  <CardContent>
                    <div className="flex justify-center py-4 overflow-auto">
                      <div className="grid grid-cols-4 gap-1">
                        <div key="header-row" className="flex items-center justify-center p-2 font-medium">
                          Actual ↓ Predicted →
                        </div>
                        <div key="header-col1" className="flex items-center justify-center p-2 font-medium">
                          Class 1
                        </div>
                        <div key="header-col2" className="flex items-center justify-center p-2 font-medium">
                          Class 2
                        </div>
                        <div key="header-col3" className="flex items-center justify-center p-2 font-medium">
                          Class 3
                        </div>

                        {modelResults.confusion_matrix.map((row, i) => (
                          <>
                            <div key={`row-${i}-label`} className="flex items-center justify-center p-2 font-medium">
                              Class {i + 1}
                            </div>
                            {row.map((cell, j) => (
                              <div
                                ...
                                className={`flex items-center justify-center p-2 rounded-md font-bold ${
                                  i === j ? "bg-green-500/20 dark:bg-green-900/20" : "bg-red-500/10 dark:bg-red-900/10"
                                }`}
                              >
                                {cell}
                              </div>
              ...
              <TabsContent value="importance">
                <Card className="border-border/40 bg-card/50 backdrop-blur-sm">
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      {modelResults.feature_importance.map((feature, i) => (
